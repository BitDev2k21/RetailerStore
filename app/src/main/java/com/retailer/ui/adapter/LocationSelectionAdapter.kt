...
class LocationSelectionAdapter(callBack: (pos: Int) -> Unit) :
        RecyclerView.Adapter<LocationSelectionAdapter.Holder>() {
    var callBack: (pos: Int) -> Unit
    var businessLineModels: ArrayList<GetLocation.Location>? = null

    init {
        this.callBack = callBack
    }

    fun setData(businessLineModels: ArrayList<GetLocation.Location>) {
