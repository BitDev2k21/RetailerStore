...
class CitySelectionAdapter(callBack: (pos: Int) -> Unit) : RecyclerView.Adapter<CitySelectionAdapter.Holder>() {

    var callBack: (pos: Int) -> Unit
    var businessLineModels: ArrayList<CityResponse.City>? = null

    init {
        this.callBack = callBack
         }

    fun setData(businessLineModels: ArrayList<CityResponse.City>) {
