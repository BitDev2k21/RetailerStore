...
class StateSelectionAdapter(callBack: (pos: Int) -> Unit) :
        RecyclerView.Adapter<StateSelectionAdapter.Holder>() {
    var callBack: (pos: Int) -> Unit
    var businessLineModels: ArrayList<StateResponse.State>? = null

    init {
        this.callBack = callBack
    }

    fun setData(businessLineModels: ArrayList<StateResponse.State>) {
